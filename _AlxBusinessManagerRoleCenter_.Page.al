page 50089 "AlxBusinessManagerRoleCenter"
{
    // CurrPage."Help And Setup List".ShowFeatured;
    Caption = 'Comidas populares';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(Control16; AlxO365Activities)
            {
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group(Payments)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Reconciliar pagos importados';
                    Image = ApplyEntries;
                ...
                action("Register Customer Payments")
                {
                    ...
                    ApplicationArea = Basic, Suite;
                    Caption = 'Registrar pagos de cliente';
                    Image = Payment;
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Crear pagos a proveedores';
            ...
            group(Reports)
            {
                ...
                group("Financial Statements")
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Extracto de flujos de efectivo';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Extracto de ganancias retenidas';
                        Image = "Report";
