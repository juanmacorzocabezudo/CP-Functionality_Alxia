report 50004 AlxInformeHistFactVtaDetallada
{
    ApplicationArea = Basic, Suite;
    Caption = 'Informe Hist. Factura Venta - Impresión Detallada';
    ...
    rendering
    {
        layout(ImpresionPorCapitulo)
        {
            Type = RDLC;
            Caption = 'Informe Hist. Factura Venta - Impresión detallada';
            LayoutFile = './src/Layout/50004.InformeHistFactVtaDetallada2.rdl';
            Summary = './src/Layout/50004.InformeHistFactVtaDetallada2.rdl';
        }
    }
    labels
    {
