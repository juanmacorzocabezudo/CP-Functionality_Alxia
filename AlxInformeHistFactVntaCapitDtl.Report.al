report 50003 AlxInformeHistFactVntaCapitDtl
{
    ApplicationArea = Basic, Suite;
    Caption = 'Informe Hist. Factura Venta - Impresión por Capítulo Detallado';
    ...
    dataset
    {
        ...
        dataitem(Factura; "Sales Invoice Header")
        {
            ...
            trigger OnAfterGetRecord()
            var
                lt_MovsCliente: Record "Cust. Ledger Entry";
            begin
    ...
    rendering
    {
        layout(ImpresionPorCapitulo)
        {
            Type = RDLC;
            Caption = 'Informe Hist. Factura Venta - Impresión por capítulo detallado';
            LayoutFile = './src/Layout/50003.InformeHistFactVntaCapitDtl2.rdl';
            Summary = './src/Layout/50003.InformeHistFactVntaCapitulo.rdl';
        }
    }
    labels
    {
