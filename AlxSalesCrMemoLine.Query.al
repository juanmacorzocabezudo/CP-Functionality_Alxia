query 50001 AlxSalesCrMemoLine
{
    Caption = 'AlxSalesCrMemoLine';
    QueryType = Normal;
    ...
    elements
    {
            ...
            "Sales Cr.Memo Line")
        {
                ...
                "Sales Cr.Memo Header")
            {
                ...
                column(PrepmtCrMemoNoSeries;
                    "Prepmt. Cr. Memo No. Series")
                {
                }
                column(PrepaymentCreditMemo;
                ...
                column(RcvdfromCountRegionCode;
                ...
                column(ReturnOrderNo;
                    "Return Order No.")
                {
                }
                column(ReturnOrderNoSeries;
                ...
                column(GetReturnReceiptUsed;
                    "Get Return Receipt Used")
                {
                }
                column(DraftCrMemoSystemId;
                    "Draft Cr. Memo SystemId")
                {
                }
                column(CorrectedInvoiceNo;
