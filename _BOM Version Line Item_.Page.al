page 50051 "BOM Version Line Item"
{
    Caption = 'BOM Version Line Item';
    PageType = ListPart;
    SourceTable = "BOM Version Lines";
    DataCaptionFields = "Parent Item No.";
    MultipleNewLines = true;
    SourceTableView = SORTING("Parent Item No.", Type, TipoRecurso, Position)ORDER(Ascending)WHERE(Type=CONST(Item));
