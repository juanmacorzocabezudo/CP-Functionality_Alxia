report 50005 "Evento Impresion por Capitulo"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Evento - Impresión por Capitulo';
    ...
    rendering
    {
        layout(ImpresionPorCapitulo)
        {
            Type = RDLC;
            Caption = 'Evento - Impresión por Capitulo';
            LayoutFile = './src/Layout/50005.EventoImpresionPorCapitulo.rdl';
            Summary = './src/Layout/50005.EventoImpresionPorCapitulo.rdl';
        }
    }
    labels
    {
    ...
    // Observaciones
    Lbl_Observaciones='OBERVACIONES';
