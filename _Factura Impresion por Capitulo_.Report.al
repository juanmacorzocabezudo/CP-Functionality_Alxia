report 50012 "Factura Impresion por Capitulo"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Factura - Impresión por Capitulo';
    ...
    rendering
    {
        layout(ImpresionPorCapitulo)
        {
            Type = RDLC;
            Caption = 'Factura - Impresión por Capitulo';
            LayoutFile = './src/Layout/50012.FacturaImpresionPorCapitulo.rdl';
            Summary = './src/Layout/50012.FacturaImpresionPorCapitulo.rdl';
        }
    }
    labels
    {
